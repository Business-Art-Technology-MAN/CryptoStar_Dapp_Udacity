...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.name(),"CryptoStar");
    assert.equal(await instance.symbol(),"STNT");
})
...
it('lets a user transfer a star', async() => {
    ...
    let user2 = accounts[2];
    let starId1 = 9;
    await instance.createStar('awesome star 9', starId1, {from: user1});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let user2 = accounts[2];
    let starId1 = 10;
    let starName = "Frodo 125"
    await instance.createStar(starName, starId1, {from: user1});
    let nameReturned = await instance.lookUptokenIdToStarInfo(starId1, {from: user1});
    assert.equal(nameReturned, starName);
});